...
class EmployeeDocumentService:
    ...
    def create_document(self, *, employee_id: str, document_type_code: str, expires_on: str, status: str) -> EmployeeDocument:
        with self._lock:
    ...
    def update_document(self, document_id: str, *, expires_on: str | None, status: str | None) -> EmployeeDocument:
        with self._lock:
            if document_id not in self._by_id:
                raise KeyError("employee document not found")
