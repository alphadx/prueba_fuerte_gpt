...
def test_document_types_crud_flow_for_rrhh() -> None:
    ...
    create_response = client.post(
        "/document-types",
        json={"code": "LIC", "name": "Licencia Conducir", "requires_expiry": True, "is_active": True},
    ...
    patch_response = client.patch(
        ...
        json={"name": "Licencia Clase B", "requires_expiry": False},
        headers=rrhh_headers,
    )
...
def test_document_types_reject_duplicate_code() -> None:
    ...
    second = client.post(
        "/document-types",
        json={"code": "LIC", "name": "Otra Licencia", "requires_expiry": False, "is_active": True},
        headers=headers,
    )
